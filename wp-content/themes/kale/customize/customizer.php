...
function kale_customizer_fields( $fields ) {
    ...
    $fields[] = array(
        ...
        'description' => 
            ...
            '<p><a href="https://www.lyrathemes.com/kale-pro/" target="_blank"><img src="' . esc_url( get_parent_theme_file_uri( 'customize/images/kale-pro-1.png' ) ) . '" /></a><br />' . 
            '<p><a href="https://www.lyrathemes.com/kale-pro/" target="_blank"><img src="' . esc_url( get_parent_theme_file_uri( 'customize/images/kale-pro-2.png' ) ) . '" /></a><br />' . 
            '<p><a href="https://www.lyrathemes.com/kale-pro/" target="_blank"><img src="' . esc_url( get_parent_theme_file_uri( 'customize/images/kale-pro-3.png' ) ) . '" /></a><br />' . 
            '<hr />' . 
