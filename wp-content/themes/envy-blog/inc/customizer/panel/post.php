...
Kirki::add_field( 'envy-blog_config', array(
    ...
    'choices'     => array(
        'post-layout-1'         => THEME_URI . '/inc/assets/images/post/post-layout-1.svg',
    ),
) );
...
Kirki::add_field( 'envy-blog_config', array(
    ...
    'choices'     => array(
        'navigation-layout-2'   => THEME_URI . '/inc/assets/images/post/post-navigation/post-navigation-layout-2.svg',
    ),
) );
