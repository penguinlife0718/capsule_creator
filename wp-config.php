 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'oh)Y+rN}tW?P-o0YVDKhIF&aQM[7=}GW?4G1FP!1TN,$-_x8!@Rp+~ZAB_($~z~D');
define('SECURE_AUTH_KEY',  'Tka>byUjcJiB,Uo>?^gW&tab0c1Q%e>x<]`( |*7WH,Yu|e:qIzU$~P1/fM.e/fV');
define('LOGGED_IN_KEY',    'sT4r% |g=q2dg(fKV~3YP1,eQ[Wv&?-uV;{<c~ik^)sM4qUr)afQ(3X18[2NQ0Ke');
define('NONCE_KEY',        '~Qyz$;Va=?kMW>kuv4pWENk]8xC)F(TKzxxFaxoN6OS7hg8hSqjz/<ZCQiqq|J4!');
define('AUTH_SALT',        'J<902SuvM}+Z9oX`[dA;$b %WyEzq*P@n7e^a(8e]GS&6^7t@5K&9Xm:h|sMI~]/');
define('SECURE_AUTH_SALT', 'Buij-l~AJXY Hws,_+K@0~jmk5k`dNiI&JA+Gb Oxw5D&s-:J5|hAiLVkh.z1@fF');
define('LOGGED_IN_SALT',   'G {T8+xL)BM+eHW/1XrDBEp!Njo| 3ZmpV7}9FkGN-fa7KocS3r|8;#;!}7^Zxr)');
define('NONCE_SALT',       '975!; TpamnE>9=;}JVH!I-a%h@GD?n+FHIPK6~|pR8N*Rj)|m0WR{vY0Ypmjv}~');
